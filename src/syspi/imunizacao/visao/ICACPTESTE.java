/*
ICACP == Cadastro de Imunizacao Agendamento Crianca Periodo
*/
...
public class ICACPTESTE extends javax.swing.JDialog {

    public ICACPTESTE(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   /*
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ICACPTESTE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ICACPTESTE dialog = new ICACPTESTE(new javax.swing.JFrame(), true);
    ...
    private void botaoSalvar() {
        if (verificarTipoCampoNumero()) {
            if (!verificarSeAnoJaCadastrado()) {
                ...
                JOptionPane.showMessageDialog(null, "Este ano ja esta cadastrado.");
            }
        }
