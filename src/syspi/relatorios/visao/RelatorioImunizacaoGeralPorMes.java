...
import temp.relatorios.ImunizacaoGeral;
 ...
 * @author AQUI
 */
public class RelatorioImunizacaoGeralPorMes extends javax.swing.JDialog {

    /**
     * Creates new form RelatorioGeralPorMes
     */
    public RelatorioImunizacaoGeralPorMes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatório Geral de Imunizações por mês");
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        mostrarJanelaRelatoriosImunzacaoesGerais();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioImunizacaoGeralPorMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RelatorioImunizacaoGeralPorMes dialog = new RelatorioImunizacaoGeralPorMes(new javax.swing.JFrame(), true);
    ...
    */
    ImunizacaoGeral  rm;
    private void mostrarJanelaRelatoriosImunzacaoesGerais() {
       if (rm == null) {
            rm = new ImunizacaoGeral(null, true);
            rm.setVisible(true);
        } else {
            rm.setVisible(true);
        }
